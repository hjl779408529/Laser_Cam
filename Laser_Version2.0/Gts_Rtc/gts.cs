...
namespace GTS
{
...

    {
        ...
        [DllImport("gts.dll")]
        public static extern short GT_Open(short channel=0,short param=0);
        [DllImport("gts.dll")]
        ...
        [DllImport("gts.dll")]
        public static extern short GT_GetEncPosPre(short encoder,out double pValue,short count,out uint pClock);
        [DllImport("gts.dll")]
